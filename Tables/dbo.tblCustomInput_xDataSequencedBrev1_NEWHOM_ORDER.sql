CREATE TABLE [dbo].[tblCustomInput_xDataSequencedBrev1_NEWHOM_ORDER]
(
[pkid] [int] NULL,
[orderdetailid] [varchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[enterdate] [varchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]