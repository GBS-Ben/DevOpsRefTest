CREATE TABLE [dbo].[tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex]
(
...
[split] [bit] NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex_split] DEFAULT ((0)),
[SwitchSortOrder] [int] NULL,
[ThresholdOfTime] [bit] NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex_ThresholdOfTime] DEFAULT ((0)),
[simplex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex_simplex] DEFAULT ((0)),
[duplex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex_duplex] DEFAULT ((0)),
[fplex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex_fplex] DEFAULT ((0)),
[isFlipped] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex_isFlipped] DEFAULT ((0))
) ON [PRIMARY]