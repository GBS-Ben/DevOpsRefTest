CREATE TABLE [dbo].[tblCustomInput_xDataSequencedBrev1_NEWHOMx]
(
[pkid] [int] NULL,
...
[input7] [varchar] (1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[input8] [varchar] (1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[marketCenterName] [varchar] (1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[projectDesc] [varchar] (1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[csz] [varchar] (1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[yourName2] [varchar] (1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[streetAddress] [varchar] (1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]