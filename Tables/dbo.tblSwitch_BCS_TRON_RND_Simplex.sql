CREATE TABLE [dbo].[tblSwitch_BCS_TRON_RND_Simplex]
(
[orderID] [int] NULL,
...
[expressProduction] [bit] NOT NULL,
[finishType] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tblSwitch_BCD_TRON_RND_Simplex_finishType] DEFAULT ((0))
) ON [PRIMARY]