CREATE TABLE [dbo].[tblSwitch_BC_Bounce]
(
[orderID] [int] NULL,
...
[front_UV] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BC_Bounce_front_UV] DEFAULT ((1)),
[back_UV] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BC_Bounce_back_UV] DEFAULT ((1)),
