CREATE TABLE [dbo].[tblSwitch_pUnit_TRON_RND]
(
[pUnitID] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[OPID] [int] NOT NULL,
[split] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_pUnit_TRON_RND_split] DEFAULT ((0)),
[uv_class] [nchar] (2) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[uv_sort] [int] NULL,
[simplex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_pUnit_TRON_RND_simplex] DEFAULT ((0)),
[duplex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_pUnit_TRON_RND_duplex] DEFAULT ((0)),
[resubmit] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_pUnit_TRON_RND_resubmit] DEFAULT ((0)),
[expressProduction] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_pUnit_TRON_RND_expressProduction] DEFAULT ((0)),
[inserted_on] [datetime] NULL,
[submitted_to_switch] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_pUnit_TRON_RND_submitted_to_switch] DEFAULT ((0)),
...
[fPlex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_pUnit_TRON_RND_fPlex] DEFAULT ((0)),
[isFlipped] [int] NOT NULL CONSTRAINT [DF_tblSwitch_pUnit_TRON_RND_isFlipped] DEFAULT ((0))
) ON [PRIMARY]