...
[UV] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_NC_UV] DEFAULT ((0)),
...
[fullCard] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_NC_fullCard] DEFAULT ((0))
) ON [PRIMARY]