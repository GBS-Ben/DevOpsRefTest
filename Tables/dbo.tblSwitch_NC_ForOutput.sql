CREATE TABLE [dbo].[tblSwitch_NC_ForOutput]
(
...
[UV] [int] NOT NULL CONSTRAINT [DF_tblSwitch_NC_ForOutput_UV] DEFAULT ((0)),
...
[fullCard] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_NC_ForOutput_fullCard] DEFAULT ((0))
) ON [PRIMARY]