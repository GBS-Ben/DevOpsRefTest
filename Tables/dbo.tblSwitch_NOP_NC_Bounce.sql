CREATE TABLE [dbo].[tblSwitch_NOP_NC_Bounce]
(
[orderID] [int] NULL,
...
[UV] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_NOP_NC_Bounce_UV] DEFAULT ((0)),
[env_productCode] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[fullCard] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_NOP_NC_Bounce_fullCard] DEFAULT ((0))
) ON [PRIMARY]