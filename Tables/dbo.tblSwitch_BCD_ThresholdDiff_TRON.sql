CREATE TABLE [dbo].[tblSwitch_BCD_ThresholdDiff_TRON]
(
...
[split] [bit] NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_split] DEFAULT ((0)),
[SwitchSortOrder] [int] NULL,
[ThresholdOfTime] [bit] NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_ThresholdOfTime] DEFAULT ((0)),
[simplex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_simplex] DEFAULT ((0)),
[duplex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_duplex] DEFAULT ((0)),
[fplex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_fplex] DEFAULT ((0)),
[isFlipped] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BCD_ThresholdDiff_TRON_isFlipped] DEFAULT ((0))
) ON [PRIMARY]