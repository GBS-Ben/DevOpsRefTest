...
[notesWritten_imageFileCreation] [bit] NOT NULL CONSTRAINT [DF_tblFT_Badges_notesWritten_imageFileCreation] DEFAULT ((0)),
[fastTrak_shippingLabelOption1] [bit] NULL CONSTRAINT [DF_tblFT_Badges_fastTrak_shippingLabelOption1] DEFAULT ((0)),
[fastTrak_shippingLabelOption2] [bit] NULL CONSTRAINT [DF_tblFT_Badges_fastTrak_shippingLabelOption2] DEFAULT ((0)),
[fastTrak_shippingLabelOption3] [bit] NULL CONSTRAINT [DF_tblFT_Badges_fastTrak_shippingLabelOption3] DEFAULT ((0)),
[fastTrak_resubmit] [bit] NULL CONSTRAINT [DF_tblFT_Badges_fastTrak_resubmit] DEFAULT ((0))
) ON [PRIMARY]