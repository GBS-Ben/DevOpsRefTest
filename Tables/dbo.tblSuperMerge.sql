CREATE TABLE [dbo].[tblSuperMerge]
(
...
[overflow1] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[overflow2] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[overflow3] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[overflow4] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[overflow5] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE CLUSTERED INDEX [PKID_IX] ON [dbo].[tblSuperMerge] ([pkid]) ON [PRIMARY]