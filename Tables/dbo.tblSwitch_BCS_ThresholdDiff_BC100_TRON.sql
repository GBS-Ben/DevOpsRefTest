CREATE TABLE [dbo].[tblSwitch_BCS_ThresholdDiff_BC100_TRON]
(
...
[ThresholdOfTime] [int] NULL CONSTRAINT [DF_tblSwitch_BCS_ThresholdDiff_BC100_TRON_ThresholdOfTime] DEFAULT ((0)),
[simplex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BCS_ThresholdDiff_BC100_TRON_simplex] DEFAULT ((0)),
[duplex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BCS_ThresholdDiff_BC100_TRON_duplex] DEFAULT ((0)),
[fplex] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BCS_ThresholdDiff_BC100_TRON_fplex] DEFAULT ((0))
) ON [PRIMARY]