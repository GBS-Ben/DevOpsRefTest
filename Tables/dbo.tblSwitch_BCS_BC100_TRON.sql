CREATE TABLE [dbo].[tblSwitch_BCS_BC100_TRON]
(
[orderID] [int] NULL,
...
[finishType] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tblSwitch_BCS_BC100_TRON_finishType] DEFAULT ((0))
) ON [PRIMARY]