CREATE TABLE [dbo].[tblSwitch_NOP_NC]
(
[orderID] [int] NULL,
...
[UV] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_NOP_NC_UV] DEFAULT ((0)),
...
[fullCard] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_NOP_NC_fullCard] DEFAULT ((0))
) ON [PRIMARY]