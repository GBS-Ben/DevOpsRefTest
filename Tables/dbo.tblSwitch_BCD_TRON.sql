CREATE TABLE [dbo].[tblSwitch_BCD_TRON]
(
[orderID] [int] NULL,
...
[finishType] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_tblSwitch_BCD_TRON_finishType] DEFAULT ((0))
) ON [PRIMARY]