...
[front_UV] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BC_frontUV] DEFAULT ((1)),
[back_UV] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_BC_backUV] DEFAULT ((1)),
