CREATE TABLE [dbo].[tempJF_reportForMike_businessEmails_forMarketing_072018_02]
(
...
[URL1] [varchar] (4) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[URL2] [varchar] (4) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
) ON [PRIMARY]