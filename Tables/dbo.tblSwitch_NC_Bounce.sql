CREATE TABLE [dbo].[tblSwitch_NC_Bounce]
(
[orderID] [int] NULL,
...
[UV] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_NC_Bounce_UV] DEFAULT ((0)),
...
[fullCard] [bit] NOT NULL CONSTRAINT [DF_tblSwitch_NC_Bounce_fullCard] DEFAULT ((0))
) ON [PRIMARY]