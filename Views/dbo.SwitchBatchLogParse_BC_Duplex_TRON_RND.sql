create view SwitchBatchLogParse_BC_Duplex_TRON_RND as
select flowName
,a.PKID
,a.ordersProductsID
,a.batchTimestamp
...
,json_front_UV int '$.front_UV'
,json_back_UV int '$.back_UV'
,json_env_productCode nvarchar(50) '$.env_productCode'
,json_env_productName nvarchar(255) '$.env_productName'
,json_env_productQuantity int '$.env_productQuantity'
,json_env_color nvarchar(255) '$.env_color'
,json_option_cause nvarchar(255) '$.option_cause'
,json_option_customInside nvarchar(255) '$.option_customInside'
,json_option_envelope nvarchar(255) '$.option_envelope'
,json_option_cov nvarchar(255) '$.option_cov'
,json_option_bak nvarchar(255) '$.option_bak'
,json_option_customEnvelope nvarchar(255) '$.option_customEnvelope'
,json_customBackground nvarchar(255) '$.customBackground'
,json_sortOrder int '$.sortOrder'
,json_expressProduction bit '$.expressProduction'
,json_pUnitID nvarchar(50) '$.pUnitID'
,json_split bit '$.split'
,json_SwitchSortOrder int '$.SwitchSortOrder'
,json_ThresholdOfTime bit '$.ThresholdOfTime'
,json_simplex bit '$.simplex'
,json_duplex bit '$.duplex'
,json_fplex bit '$.fplex'
,json_isFlipped bit '$.isFlipped'
) as b
where flowName = 'BC_Duplex_TRON_RND'