...
------------------------------------------------------------------------------------------------------------------------ SEASONAL
CREATE PROC ReportSalesBySeason
AS
...
--kill tables
TRUNCATE TABLE [ReportMMYYYY_WithSales_bySeason]
...
WHERE a.productCode IN ('FB', 'CA', 'BB', 'HY', 'PG', 'NS', 'BK')
ORDER BY 1
...
INSERT INTO [ReportMMYYYY_WithSales_bySeason] (PC, MM, YYYY, TotalOPIDSales, TotalOPPXSales, TotalSales)
...
FROM [ReportMMYYYY_WithSales_bySeason]
ORDER BY PC, YYYY, MM
