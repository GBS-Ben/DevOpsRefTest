CREATE PROC [dbo].[usp_FT_getActive_Sort_testJF]	
...
-- Sample Use	EXEC [usp_FT_getActive_Sort_testJF] 'Order #', 'DESC'
...
-- 7/16/18		Pulled code from WHERE clause: AND op.fastTrak_completed = 0; AND p.fastTrak_productType IN ('Name Badge', 'QuickCard', 'QM', 'CM', 'CACX', 'Pen', 'FC', 'NC', 'JU', 'EX', 'BU'); 
