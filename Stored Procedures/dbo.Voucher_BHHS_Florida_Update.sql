CREATE PROCEDURE [dbo].[Voucher_BHHS_Florida_Update]
AS
...
FROM OPENROWSET('Microsoft.ACE.OLEDB.12.0', 'Excel 12.0;Database=c:\Excel\BHHS_Florida_Realty_Voucher_Bank.xlsx;HDR=YES', 'SELECT * FROM [BHHS Florida$]') o 
...
FROM OPENROWSET('Microsoft.ACE.OLEDB.12.0', 'Excel 12.0;Database=c:\Excel\BHHS_Florida_Realty_Voucher_Bank.xlsx;HDR=YES', 'SELECT * FROM [BHHS Florida$]') o --[gbsAcquire].[dbo].[eXpVoucherCodes]
