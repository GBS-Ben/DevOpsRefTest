CREATE PROCEDURE [dbo].[usp_Switch_BC100_Duplex_TRON] 
AS
/*
-------------------------------------------------------------------------------
Author      Jeremy Fifer
...
03/25/21		CKB, modified for BC100
04/21/21		CKB, added modified file check #5
...
BEGIN TRY
DECLARE @flowName AS VARCHAR(20) = 'BC 100'
...
EXEC ProcessStatus_Update 'BC100_Duplex_TRON Switch SP', @lastRunDate;
...
INSERT INTO BC100_LOG (lognote) SELECT '1'
...
DELETE FROM tblSwitch_pUnit_BC100_TRON
WHERE submitted_to_switch = 0
AND split = 0
AND duplex = 1

-- Initialize data set
TRUNCATE TABLE tblSwitch_OPID_BC100_TRON
INSERT INTO tblSwitch_OPID_BC100_TRON (OPID, ReadyForSwitch)
...
TRUNCATE TABLE tblSwitch_BCD_BC100_TRON
INSERT INTO tblSwitch_BCD_BC100_TRON (orderID, orderNo, orderDate, customerID, 
...
INNER JOIN tblOrders_Products op ON a.orderID = op.orderID
INNER JOIN tblProducts p ON op.productID = p.productID
INNER JOIN tblSwitch_OPID_BC100_TRON q ON op.ID = q.OPID
WHERE op.[ID] NOT IN 
	(SELECT ordersProductsID 
	FROM tblSwitch_BCD_BC100_TRON
	WHERE ordersProductsID IS NOT NULL)

INSERT INTO BC100_LOG (lognote) SELECT '2'
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
--////////////////////////////////////////////////// QUANTITY WORK /////////////////////////////////
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

--// First, fix productQuantity if fasTrak_newQTY value exists
UPDATE tblSwitch_BCD_BC100_TRON
SET productQuantity = b.fastTrak_newQTY
FROM tblSwitch_BCD_BC100_TRON a
...
--// Repopulate tblSwitch_BCD_TRON with accurate data to begin more edits.
TRUNCATE TABLE tblSwitch_BCD_BC100_TRON
INSERT INTO tblSwitch_BCD_BC100_TRON (orderID, orderNo, orderDate, customerID, shippingAddressID, shipCompany, shipFirstName, shipLastName, shipAddress1, shipAddress2, shipCity, shipState, shipZip, shipCountry, shipPhone, productCode, productName, shortName, productQuantity, packetValue, variableTopName, variableBottomName, variableWholeName, backName, numUnits, displayedQuantity, ordersProductsID, shipsWith, resubmit, shipType, samplerRequest, multiCount, totalCount, displayCount, background, templateFile, team1FileName, team2FileName, team3FileName, team4FileName, team5FileName, team6FileName, groupID, productID, parentProductID, switch_create, switch_createDate, switch_approve, switch_approveDate, switch_print, switch_printDate, switch_import, mo_orders_Products, mo_orders, mo_customers, mo_customers_ShippingAddress, mo_oppo, customProductCount, customProductCode1, customProductCode2, customProductCode3, customProductCode4, fasTrakProductCount, fasTrakProductCode1, fasTrakProductCode2, fasTrakProductCode3, fasTrakProductCode4, stockProductCount, stockProductQuantity1, stockProductCode1, stockProductDescription1, stockProductQuantity2, stockProductCode2, stockProductDescription2, stockProductQuantity3, stockProductCode3, stockProductDescription3, stockProductQuantity4, stockProductCode4, stockProductDescription4, stockProductQuantity5, stockProductCode5, stockProductDescription5, stockProductQuantity6, stockProductCode6, stockProductDescription6, front_UV, back_UV, customBackground, expressProduction)
SELECT orderID, orderNo, orderDate, customerID, shippingAddressID, shipCompany, shipFirstName, shipLastName, shipAddress1, shipAddress2, shipCity, shipState, shipZip, shipCountry, shipPhone, productCode, productName, shortName, productQuantity, packetValue, variableTopName, variableBottomName, variableWholeName, backName, numUnits, displayedQuantity, ordersProductsID, shipsWith, resubmit, shipType, samplerRequest, multiCount, totalCount, displayCount, background, templateFile, team1FileName, team2FileName, team3FileName, team4FileName, team5FileName, team6FileName, groupID, productID, parentProductID, switch_create, switch_createDate, switch_approve, switch_approveDate, switch_print, switch_printDate, switch_import, mo_orders_Products, mo_orders, mo_customers, mo_customers_ShippingAddress, mo_oppo, customProductCount, customProductCode1, customProductCode2, customProductCode3, customProductCode4, fasTrakProductCount, fasTrakProductCode1, fasTrakProductCode2, fasTrakProductCode3, fasTrakProductCode4, stockProductCount, stockProductQuantity1, stockProductCode1, stockProductDescription1, stockProductQuantity2, stockProductCode2, stockProductDescription2, stockProductQuantity3, stockProductCode3, stockProductDescription3, stockProductQuantity4, stockProductCode4, stockProductDescription4, stockProductQuantity5, stockProductCode5, stockProductDescription5, stockProductQuantity6, stockProductCode6, stockProductDescription6, front_UV, back_UV, customBackground, expressProduction
FROM tblSwitch_BCD_Bounce_BC100_TRON
ORDER BY ordersProductsID, packetValue

--// update packetValue with sortable multi-digit numbers
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, '1 of', '01 of') WHERE packetValue LIKE '1 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, '2 of', '02 of') WHERE packetValue LIKE '2 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, '3 of', '03 of') WHERE packetValue LIKE '3 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, '4 of', '04 of') WHERE packetValue LIKE '4 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, '5 of', '05 of') WHERE packetValue LIKE '5 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, '6 of', '06 of') WHERE packetValue LIKE '6 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, '7 of', '07 of') WHERE packetValue LIKE '7 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, '8 of', '08 of') WHERE packetValue LIKE '8 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, '9 of', '09 of') WHERE packetValue LIKE '9 of%'

UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, 'of 1', 'of 01') WHERE packetValue LIKE '%of 1'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, 'of 2', 'of 02') WHERE packetValue LIKE '%of 2'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, 'of 3', 'of 03') WHERE packetValue LIKE '%of 3'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, 'of 4', 'of 04') WHERE packetValue LIKE '%of 4'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, 'of 5', 'of 05') WHERE packetValue LIKE '%of 5'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, 'of 6', 'of 06') WHERE packetValue LIKE '%of 6'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, 'of 7', 'of 07') WHERE packetValue LIKE '%of 7'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, 'of 8', 'of 08') WHERE packetValue LIKE '%of 8'
UPDATE tblSwitch_BCD_BC100_TRON SET packetValue = REPLACE(packetValue, 'of 9', 'of 09') WHERE packetValue LIKE '%of 9'
...
INSERT INTO BC100_LOG (lognote) SELECT '3'
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
--//////////////////////////////////////////////////// FINISH TYPE /////////////////////////////////////////////	
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
SET @json = (SELECT orderid,@flowName as switchflow from tblSwitch_BCD_BC100_TRON FOR JSON PATH);
...
SET shipsWith = CASE WHEN t.CustomProductCount > 0  THEN 'Custom'
					 ...
					 ELSE 'Ship' END
FROM tblSwitch_BCD_BC100_TRON s
...
INSERT INTO BC100_LOG (lognote) SELECT '4'
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
--//////////////////////////////////////////////////// SHIP TYPE //////////////////////////////////	
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
FROM  tblSwitch_BCD_BC100_TRON t
...
TRUNCATE TABLE tblSwitch_BCD_distinctIDCount_BC100_TRON
INSERT INTO tblSwitch_BCD_distinctIDCount_BC100_TRON (orderID, ordersProductsID)
SELECT DISTINCT orderID, ordersProductsID
FROM tblSwitch_BCD_BC100_TRON

TRUNCATE TABLE tblSwitch_BCD_distinctIDCount2_BC100_TRON
INSERT INTO tblSwitch_BCD_distinctIDCount2_BC100_TRON (orderID, countOrderID)
SELECT orderID, COUNT(orderID) AS 'countOrderID'
FROM tblSwitch_BCD_distinctIDCount_BC100_TRON
GROUP BY orderID
ORDER BY OrderId
...
FROM tblSwitch_BCD_BC100_TRON a 
INNER JOIN tblSwitch_BCD_distinctIDCount2_BC100_TRON b
...
IF OBJECT_ID(N'tblSwitch_BCD_displayCount_TRON', N'U') IS NOT NULL
DROP TABLE tblSwitch_BCD_displayCount_BC100_TRON

CREATE TABLE tblSwitch_BCD_displayCount_BC100_TRON
...
TRUNCATE TABLE tblSwitch_BCD_displayCount_BC100_TRON
INSERT INTO tblSwitch_BCD_displayCount_BC100_TRON (orderID, ordersProductsID, totalCount)
...
BEGIN
	...
	FROM tblSwitch_BCD_displayCount_BC100_TRON
...
--// update packetValue with sortable multi-digit numbers
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, '1 of', '01 of') WHERE displayCount LIKE '1 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, '2 of', '02 of') WHERE displayCount LIKE '2 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, '3 of', '03 of') WHERE displayCount LIKE '3 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, '4 of', '04 of') WHERE displayCount LIKE '4 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, '5 of', '05 of') WHERE displayCount LIKE '5 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, '6 of', '06 of') WHERE displayCount LIKE '6 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, '7 of', '07 of') WHERE displayCount LIKE '7 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, '8 of', '08 of') WHERE displayCount LIKE '8 of%'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, '9 of', '09 of') WHERE displayCount LIKE '9 of%'

UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, 'of 1', 'of 01') WHERE displayCount LIKE '%of 1'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, 'of 2', 'of 02') WHERE displayCount LIKE '%of 2'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, 'of 3', 'of 03') WHERE displayCount LIKE '%of 3'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, 'of 4', 'of 04') WHERE displayCount LIKE '%of 4'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, 'of 5', 'of 05') WHERE displayCount LIKE '%of 5'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, 'of 6', 'of 06') WHERE displayCount LIKE '%of 6'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, 'of 7', 'of 07') WHERE displayCount LIKE '%of 7'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, 'of 8', 'of 08') WHERE displayCount LIKE '%of 8'
UPDATE tblSwitch_BCD_BC100_TRON SET displayCount = REPLACE(displayCount, 'of 9', 'of 09') WHERE displayCount LIKE '%of 9'

UPDATE tblSwitch_BCD_BC100_TRON SET switch_approve = 0
UPDATE tblSwitch_BCD_BC100_TRON SET switch_print = 0
UPDATE tblSwitch_BCD_BC100_TRON SET switch_approveDate = GETDATE()
UPDATE tblSwitch_BCD_BC100_TRON SET switch_printDate = GETDATE()
UPDATE tblSwitch_BCD_BC100_TRON SET switch_createDate = GETDATE()
...
UPDATE x
SET resubmit = 1
FROM tblSwitch_BCD_BC100_TRON x
WHERE EXISTS
	(SELECT TOP 1 1
...
IF OBJECT_ID('tempdb..#tempResubChoice_BCD_TRON') IS NOT NULL 
DROP TABLE #tempResubChoice_BCD_BC100_TRON

CREATE TABLE #tempResubChoice_BCD_BC100_TRON (
RowID INT IDENTITY(1, 1), 
OPID INT)
...
INSERT INTO #tempResubChoice_BCD_BC100_TRON (OPID)
...
BEGIN
	 SELECT @OPID_rs = OPID
	 FROM #tempResubChoice_BCD_BC100_TRON
...
IF OBJECT_ID(N'tblSwitch_BC100_TOT', N'U') IS NOT NULL
DROP TABLE tblSwitch_BC100_TOT

CREATE TABLE tblSwitch_BC100_TOT
	(RowID INT IDENTITY(1, 1), 
	OPID INT, 
	orderDate DATETIME,
	dateCount INT)
...
--// Create table
TRUNCATE TABLE tblSwitch_BC100_TOT
INSERT INTO tblSwitch_BC100_TOT (OPID, orderDate)
SELECT DISTINCT a.OPID, o.orderDate
FROM tblSwitch_OPID_BC100_TRON a
...
BEGIN
	...
	FROM tblSwitch_OPID_BC100_TRON a
	INNER JOIN tblSwitch_BC100_TOT t ON a.OPID = t.OPID
	WHERE t.dateCount >= 2
...
INSERT INTO tblSwitch_pUnit_BC100_TRON (pUnitID, OPID, duplex, orderID, orderNo, orderDate, customerID, shippingAddressID, shipCompany, shipFirstName, shipLastName, shipAddress1, shipAddress2, shipCity, shipState,
...
SET uv_class = 'YY',
	   uv_sort = 1
FROM tblSwitch_pUnit_BC100_TRON a
INNER JOIN tblSwitch_BCD_BC100_TRON b
...
INSERT INTO BC100_LOG (lognote) SELECT '6'
-- UV ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-- Splits are included in the calculation now since we are pulling exclusively from tblSwitch_pUnit_TRON rather than joining on BCD.
...
TRUNCATE TABLE tblSwitch_BCD_ThresholdDiff_BC100_TRON
...
BEGIN
	SET @SQLStatement = N'
	INSERT INTO tblSwitch_BCD_ThresholdDiff_BC100_TRON (orderID, orderNo, orderDate, customerID, shippingAddressID, shipCompany, shipFirstName, shipLastName, shipAddress1, shipAddress2, shipCity, shipState, shipZip, shipCountry, shipPhone, productCode, productName, shortName, productQuantity, packetValue, variableTopName, variableBottomName, variableWholeName, backName, numUnits, displayedQuantity, ordersProductsID, shipsWith, resubmit, shipType, samplerRequest, multiCount, totalCount, displayCount, background, templateFile, team1FileName, team2FileName, team3FileName, team4FileName, team5FileName, team6FileName, groupID, productID, parentProductID, switch_create, switch_createDate, switch_approve, switch_approveDate, switch_print, switch_printDate, switch_import, mo_orders_Products, mo_orders, mo_customers, mo_customers_ShippingAddress, mo_oppo, customProductCount, customProductCode1, customProductCode2, customProductCode3, customProductCode4, fasTrakProductCount, fasTrakProductCode1, fasTrakProductCode2, fasTrakProductCode3, fasTrakProductCode4, stockProductCount, stockProductQuantity1, stockProductCode1, stockProductDescription1, stockProductQuantity2, stockProductCode2, stockProductDescription2, stockProductQuantity3, stockProductCode3, stockProductDescription3, stockProductQuantity4, stockProductCode4, stockProductDescription4, stockProductQuantity5, stockProductCode5, stockProductDescription5, stockProductQuantity6, stockProductCode6, stockProductDescription6, front_UV, back_UV, customBackground, expressProduction, pUnitID, split, sortOrder)
...
-- Now, any OPIDs that do not exist in the output data (tblSwitch_BCD_ThresholdDiff_TRON), but surpass the time threshold, must be inserted despite any havoc it creates on the six/group work.
-- IF @TOT >= 1, then grab all.
SET @TOT = 0
SET @TOT = (SELECT COUNT(ID)
					FROM tblSwitch_OPID_BC100_TRON a
					INNER JOIN tblSwitch_pUnit_BC100_TRON b
						ON a.OPID = b.OPID
					WHERE b.uv_sort = 1
					...
					AND b.pUnitID NOT IN
						(SELECT pUnitID
						FROM tblSwitch_BCD_ThresholdDiff_BC100_TRON))
...
BEGIN
	...
	FROM tblSwitch_pUnit_BC100_TRON t
	WHERE uv_sort = 1
	AND submitted_to_switch = 0
	AND pUnitID NOT IN
		(SELECT pUnitID
...
--Exception Threshold: Brute force any pUnit that has been resubmitted or has been marked for expressProduction and still has not made it into tblSwitch_BCD_ThresholdDiff_TRON
...
INSERT INTO BC100_LOG (lognote) SELECT '7'
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
UPDATE a
SET simplex = 1
FROM tblSwitch_BCD_ThresholdDiff_BC100_TRON a
INNER JOIN tblSwitch_pUnit_BC100_TRON b ON a.pUnitID = b.pUnitID
WHERE b.simplex = 1
...
SET fPlex = 1
FROM tblSwitch_pUnit_BC100_TRON a
INNER JOIN tblSwitch_BCD_ThresholdDiff_BC100_TRON b ON a.pUnitID = b.pUnitID
WHERE a.simplex = 1
AND a.fPlex = 0
...
--first, flip it and put into tblSwitch_pUnit_TRON and then set isFlipped = 1
UPDATE tblSwitch_pUnit_BC100_TRON
SET isFlipped = 1,
...
--now, the images in tblSwitch_pUnit_TRON are correctly flipped for @NYs.
--next, update tblSwitch_BCD_ThresholdDiff_TRON with the correctly flipped values from tblSwitch_pUnit_TRON and then set isFlipped = 1
UPDATE tblSwitch_BCD_ThresholdDiff_BC100_TRON
SET isFlipped = 1,
...
UPDATE tblSwitch_BCD_ThresholdDiff_BC100_TRON SET backName = 'blank.pdf' WHERE backName = '' AND fPlex = 1
UPDATE tblSwitch_BCD_ThresholdDiff_BC100_TRON SET backName = 'blank.pdf' WHERE backName = '.pdf' AND fPlex = 1
UPDATE tblSwitch_BCD_ThresholdDiff_BC100_TRON SET variableWholeName = 'blank.pdf' WHERE variableWholeName = '.pdf' AND fPlex = 1
UPDATE tblSwitch_pUnit_BC100_TRON SET backName = 'blank.pdf' WHERE backName = '.pdf' AND fPlex = 1
UPDATE tblSwitch_pUnit_BC100_TRON SET variableWholeName = 'blank.pdf' WHERE variableWholeName = '.pdf' AND fPlex = 1

UPDATE tblSwitch_BCD_ThresholdDiff_BC100_TRON SET backName = '' WHERE backName = '.pdf' AND fPlex = 0
UPDATE tblSwitch_BCD_ThresholdDiff_BC100_TRON SET variableWholeName = '' WHERE variableWholeName = '.pdf' AND fPlex = 0
UPDATE tblSwitch_pUnit_BC100_TRON SET backName = '' WHERE backName = '.pdf' AND fPlex = 0
UPDATE tblSwitch_pUnit_BC100_TRON SET variableWholeName = '' WHERE variableWholeName = '.pdf' AND fPlex = 0
...
SET switch_create = 1,
	   ...
	   fastTrak_resubmit = 0
FROM tblOrders_Products op
INNER JOIN tblSwitch_BCD_ThresholdDiff_BC100_TRON t ON op.ID = t.ordersProductsID

INSERT INTO BC100_LOG (lognote) SELECT '8'
-- Update pUNIT status indicating successful submission to switch
UPDATE tblSwitch_pUnit_BC100_TRON
SET submitted_to_switch = 1,
	   submitted_to_switch_on = GETDATE()
FROM tblSwitch_pUnit_BC100_TRON p
INNER JOIN tblSwitch_BCD_ThresholdDiff_BC100_TRON t ON p.pUnitID = t.pUnitID
...
select 
flowName = 'BC100_Duplex_TRON'
,a.PKID
,a.ordersProductsID
,batchTimestamp = @CurrentDate
,jsonData = 
       (select *
       from tblSwitch_BCD_ThresholdDiff_BC100_TRON b
       where a.PKID = b.PKID
       for json path)
from tblSwitch_BCD_ThresholdDiff_BC100_TRON a
...
--UPDATE JF_TESTBC SET testDate = GETDATE()
--select * from JF_TESTBC --2021-02-08 17:45:39.623

INSERT INTO BC100_LOG (lognote) SELECT '9'
