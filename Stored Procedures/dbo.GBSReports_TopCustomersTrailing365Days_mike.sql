CREATE proc [dbo].[GBSReports_TopCustomersTrailing365Days_mike] as
...
;WITH CTE
AS
(SELECT customerID, CONVERT(DECIMAL(10,2), SUM(ISNULL(calcOrderTotal, orderTotal))) AS 'totalRev'
FROM #tempJF_OC
...
GROUP BY oc.customerID, oc.email, cte.totalRev
