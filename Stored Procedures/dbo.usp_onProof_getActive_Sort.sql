CREATE PROC [dbo].[usp_onProof_getActive_Sort]	
...
-- Sample Use	EXEC [usp_onProof_getActive_Sort] 'Order #', 'DESC'
-- 05/08/17		Updated WHERE clause with "op.fastTrak_status = 'On Proof', jf.
...
BEGIN TRY
	...
	WHERE op.fastTrak_status = 'On Proof'
		AND op.deleteX <> 'Yes'
