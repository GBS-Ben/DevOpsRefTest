CREATE PROCEDURE [dbo].[usp_Switch_BC_Simplex_TRON_RND] 
AS
/*
-------------------------------------------------------------------------------
Author      Jeremy Fifer
...
EXEC ProcessStatus_Update 'BC_Simplex_TRON_RND Switch SP', @lastRunDate;
...
TRUNCATE TABLE tblSwitch_BCS_TRON_RND_Simplex
INSERT INTO tblSwitch_BCS_TRON_RND_Simplex (orderID, orderNo, orderDate, customerID, 
...
WHERE NOT EXISTS
	(SELECT ordersProductsID 
	FROM tblSwitch_BCS_TRON_RND_Simplex x
...
UPDATE tblSwitch_BCS_TRON_RND_Simplex
SET productQuantity = b.fastTrak_newQTY
FROM tblSwitch_BCS_TRON_RND_Simplex a
...
--// Repopulate tblSwitch_BCS_TRON_RND_Simplex with accurate data to begin more edits.
TRUNCATE TABLE tblSwitch_BCS_TRON_RND_Simplex
INSERT INTO tblSwitch_BCS_TRON_RND_Simplex (orderID, orderNo, orderDate, customerID, shippingAddressID, shipCompany, shipFirstName, shipLastName, shipAddress1, shipAddress2, shipCity, shipState, shipZip, shipCountry, shipPhone, productCode, productName, shortName, productQuantity, packetValue, variableTopName, variableBottomName, variableWholeName, backName, numUnits, displayedQuantity, ordersProductsID, shipsWith, resubmit, shipType, samplerRequest, multiCount, totalCount, displayCount, background, templateFile, team1FileName, team2FileName, team3FileName, team4FileName, team5FileName, team6FileName, groupID, productID, parentProductID, switch_create, switch_createDate, switch_approve, switch_approveDate, switch_print, switch_printDate, switch_import, mo_orders_Products, mo_orders, mo_customers, mo_customers_ShippingAddress, mo_oppo, customProductCount, customProductCode1, customProductCode2, customProductCode3, customProductCode4, fasTrakProductCount, fasTrakProductCode1, fasTrakProductCode2, fasTrakProductCode3, fasTrakProductCode4, stockProductCount, stockProductQuantity1, stockProductCode1, stockProductDescription1, stockProductQuantity2, stockProductCode2, stockProductDescription2, stockProductQuantity3, stockProductCode3, stockProductDescription3, stockProductQuantity4, stockProductCode4, stockProductDescription4, stockProductQuantity5, stockProductCode5, stockProductDescription5, stockProductQuantity6, stockProductCode6, stockProductDescription6, front_UV, back_UV, customBackground, expressProduction)
...
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, '1 of', '01 of') WHERE packetValue LIKE '1 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, '2 of', '02 of') WHERE packetValue LIKE '2 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, '3 of', '03 of') WHERE packetValue LIKE '3 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, '4 of', '04 of') WHERE packetValue LIKE '4 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, '5 of', '05 of') WHERE packetValue LIKE '5 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, '6 of', '06 of') WHERE packetValue LIKE '6 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, '7 of', '07 of') WHERE packetValue LIKE '7 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, '8 of', '08 of') WHERE packetValue LIKE '8 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, '9 of', '09 of') WHERE packetValue LIKE '9 of%'

UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, 'of 1', 'of 01') WHERE packetValue LIKE '%of 1'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, 'of 2', 'of 02') WHERE packetValue LIKE '%of 2'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, 'of 3', 'of 03') WHERE packetValue LIKE '%of 3'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, 'of 4', 'of 04') WHERE packetValue LIKE '%of 4'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, 'of 5', 'of 05') WHERE packetValue LIKE '%of 5'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, 'of 6', 'of 06') WHERE packetValue LIKE '%of 6'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, 'of 7', 'of 07') WHERE packetValue LIKE '%of 7'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, 'of 8', 'of 08') WHERE packetValue LIKE '%of 8'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET packetValue = REPLACE(packetValue, 'of 9', 'of 09') WHERE packetValue LIKE '%of 9'
...
AND oppo.textValue not like 'Soft%Touch%' --added for iFrame conversion
...
AND (oppo.optionID IN (568, 569)
  OR oppo.textValue like 'Soft%Touch%') --added for iFrame conversion
AND oppo.deleteX <> 'yes'
...
WHERE orderID IN
		...
		AND ID NOT IN
			(SELECT ordersProductsID
			FROM tblSwitch_BCS_TRON_RND_Simplex)
...
--FROM tblSwitch_BCS_TRON_RND_Simplex t
...
--// update packetValue with sortable multi-digit numbers
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, '1 of', '01 of') WHERE displayCount LIKE '1 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, '2 of', '02 of') WHERE displayCount LIKE '2 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, '3 of', '03 of') WHERE displayCount LIKE '3 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, '4 of', '04 of') WHERE displayCount LIKE '4 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, '5 of', '05 of') WHERE displayCount LIKE '5 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, '6 of', '06 of') WHERE displayCount LIKE '6 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, '7 of', '07 of') WHERE displayCount LIKE '7 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, '8 of', '08 of') WHERE displayCount LIKE '8 of%'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, '9 of', '09 of') WHERE displayCount LIKE '9 of%'

UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, 'of 1', 'of 01') WHERE displayCount LIKE '%of 1'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, 'of 2', 'of 02') WHERE displayCount LIKE '%of 2'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, 'of 3', 'of 03') WHERE displayCount LIKE '%of 3'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, 'of 4', 'of 04') WHERE displayCount LIKE '%of 4'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, 'of 5', 'of 05') WHERE displayCount LIKE '%of 5'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, 'of 6', 'of 06') WHERE displayCount LIKE '%of 6'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, 'of 7', 'of 07') WHERE displayCount LIKE '%of 7'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, 'of 8', 'of 08') WHERE displayCount LIKE '%of 8'
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET displayCount = REPLACE(displayCount, 'of 9', 'of 09') WHERE displayCount LIKE '%of 9'

UPDATE tblSwitch_BCS_TRON_RND_Simplex SET switch_approve = 0
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET switch_print = 0
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET switch_approveDate = GETDATE()
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET switch_printDate = GETDATE()
UPDATE tblSwitch_BCS_TRON_RND_Simplex SET switch_createDate = GETDATE()
...
INNER JOIN tblSwitch_BCS_TRON_RND_Simplex b ON a.OPID = b.ordersProductsID
WHERE b.front_UV = 1
AND b.back_UV = 1
AND a.Simplex = 1
AND b.finishType <> 'ST'
