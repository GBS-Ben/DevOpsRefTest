CREATE PROCEDURE [dbo].[Voucher_FATHOM_Update]
AS
--04/27/21		CKB, Markful
 ...
 --		SELECT 
	...
	--   -- ,vo.*
	--  FROM OPENROWSET('Microsoft.ACE.OLEDB.12.0', 'Excel 12.0;Database=c:\Excel\Fathom_Voucher_Bank.xlsx;HDR=YES', 'SELECT * FROM [Fathom$]') o --[gbsAcquire].[dbo].[eXpVoucherCodes]
...
FROM OPENROWSET('Microsoft.ACE.OLEDB.12.0', 'Excel 12.0;Database=c:\Excel\Fathom_Voucher_Bank.xlsx;HDR=YES', 'SELECT * FROM [Fathom$]') o
