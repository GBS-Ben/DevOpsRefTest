CREATE PROCEDURE [dbo].[ReportAllOutstandingOPIDs_AllTime_StuckInHouse] 
AS
...
INSERT INTO #StuckInHouse ([Order No], [Order Status], [Order Type], [Payment Method], [Payment Status], [Local Pickup], [Date], [OPID], [OPID Status], [Product Code], [Product Name], [Type], [Days], [Mailing], [FT Status LastMod])
