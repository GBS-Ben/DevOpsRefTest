CREATE PROCEDURE [dbo].[usp_Switch_BC_Duplex_TRON_RND] 
AS
/*
-------------------------------------------------------------------------------
Author      Jeremy Fifer
...
03/04/21		BS, added reorder to the oppo main query check.
04/07/21		CKB, added productquantity >= 5 to exclude BC100
04/22/21		JF, added business card square code throughout the count sections so that square bc's are counted on the ticket
11/10/21		CKB, modified file exists logic to match BC square.  opid missing one of two images still getting through.
...
DECLARE @flowName AS VARCHAR(20) = 'BCROUND'
...
SET @Flag = (SELECT FlagStatus 
			FROM Flags
			WHERE FlagName = 'Switch_BC_Duplex_TRON_RND')
...
EXEC ProcessStatus_Update 'BC_Duplex_TRON_RND Switch SP', @lastRunDate;
...
TRUNCATE TABLE [dbo].[tblSwitch_BCD_TRON_RND_Duplex]
INSERT INTO [dbo].[tblSwitch_BCD_TRON_RND_Duplex] (orderID, orderNo, orderDate, customerID, 
...
WHERE NOT EXISTS
	(SELECT ordersProductsID 
	FROM [dbo].[tblSwitch_BCD_TRON_RND_Duplex] x
...
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex]
SET productQuantity = b.fastTrak_newQTY
FROM [dbo].[tblSwitch_BCD_TRON_RND_Duplex] a
...
--// Repopulate [dbo].[tblSwitch_BCD_TRON_RND_Duplex] with accurate data to begin more edits.
TRUNCATE TABLE [dbo].[tblSwitch_BCD_TRON_RND_Duplex]
INSERT INTO [dbo].[tblSwitch_BCD_TRON_RND_Duplex] (orderID, orderNo, orderDate, customerID, shippingAddressID, shipCompany, shipFirstName, shipLastName, shipAddress1, shipAddress2, shipCity, shipState, shipZip, shipCountry, shipPhone, productCode, productName, shortName, productQuantity, packetValue, variableTopName, variableBottomName, variableWholeName, backName, numUnits, displayedQuantity, ordersProductsID, shipsWith, resubmit, shipType, samplerRequest, multiCount, totalCount, displayCount, background, templateFile, team1FileName, team2FileName, team3FileName, team4FileName, team5FileName, team6FileName, groupID, productID, parentProductID, switch_create, switch_createDate, switch_approve, switch_approveDate, switch_print, switch_printDate, switch_import, mo_orders_Products, mo_orders, mo_customers, mo_customers_ShippingAddress, mo_oppo, customProductCount, customProductCode1, customProductCode2, customProductCode3, customProductCode4, fasTrakProductCount, fasTrakProductCode1, fasTrakProductCode2, fasTrakProductCode3, fasTrakProductCode4, stockProductCount, stockProductQuantity1, stockProductCode1, stockProductDescription1, stockProductQuantity2, stockProductCode2, stockProductDescription2, stockProductQuantity3, stockProductCode3, stockProductDescription3, stockProductQuantity4, stockProductCode4, stockProductDescription4, stockProductQuantity5, stockProductCode5, stockProductDescription5, stockProductQuantity6, stockProductCode6, stockProductDescription6, front_UV, back_UV, customBackground, expressProduction)
SELECT orderID, orderNo, orderDate, customerID, shippingAddressID, shipCompany, shipFirstName, shipLastName, shipAddress1, shipAddress2, shipCity, shipState, shipZip, shipCountry, shipPhone, productCode, productName, shortName, productQuantity, packetValue, variableTopName, variableBottomName, variableWholeName, backName, numUnits, displayedQuantity, ordersProductsID, shipsWith, resubmit, shipType, samplerRequest, multiCount, totalCount, displayCount, background, templateFile, team1FileName, team2FileName, team3FileName, team4FileName, team5FileName, team6FileName, groupID, productID, parentProductID, switch_create, switch_createDate, switch_approve, switch_approveDate, switch_print, switch_printDate, switch_import, mo_orders_Products, mo_orders, mo_customers, mo_customers_ShippingAddress, mo_oppo, customProductCount, customProductCode1, customProductCode2, customProductCode3, customProductCode4, fasTrakProductCount, fasTrakProductCode1, fasTrakProductCode2, fasTrakProductCode3, fasTrakProductCode4, stockProductCount, stockProductQuantity1, stockProductCode1, stockProductDescription1, stockProductQuantity2, stockProductCode2, stockProductDescription2, stockProductQuantity3, stockProductCode3, stockProductDescription3, stockProductQuantity4, stockProductCode4, stockProductDescription4, stockProductQuantity5, stockProductCode5, stockProductDescription5, stockProductQuantity6, stockProductCode6, stockProductDescription6, front_UV, back_UV, customBackground, expressProduction
FROM tblSwitch_BCD_Bounce_TRON_Rnd_Duplex
ORDER BY ordersProductsID, packetValue

--// update packetValue with sortable multi-digit numbers
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, '1 of', '01 of') WHERE packetValue LIKE '1 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, '2 of', '02 of') WHERE packetValue LIKE '2 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, '3 of', '03 of') WHERE packetValue LIKE '3 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, '4 of', '04 of') WHERE packetValue LIKE '4 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, '5 of', '05 of') WHERE packetValue LIKE '5 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, '6 of', '06 of') WHERE packetValue LIKE '6 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, '7 of', '07 of') WHERE packetValue LIKE '7 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, '8 of', '08 of') WHERE packetValue LIKE '8 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, '9 of', '09 of') WHERE packetValue LIKE '9 of%'

UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, 'of 1', 'of 01') WHERE packetValue LIKE '%of 1'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, 'of 2', 'of 02') WHERE packetValue LIKE '%of 2'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, 'of 3', 'of 03') WHERE packetValue LIKE '%of 3'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, 'of 4', 'of 04') WHERE packetValue LIKE '%of 4'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, 'of 5', 'of 05') WHERE packetValue LIKE '%of 5'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, 'of 6', 'of 06') WHERE packetValue LIKE '%of 6'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, 'of 7', 'of 07') WHERE packetValue LIKE '%of 7'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, 'of 8', 'of 08') WHERE packetValue LIKE '%of 8'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET packetValue = REPLACE(packetValue, 'of 9', 'of 09') WHERE packetValue LIKE '%of 9'
...
SET @json = (SELECT orderid,@flowName as switchflow from tblSwitch_BCD_TRON_RND_Duplex FOR JSON PATH);
...
SET shipsWith = CASE WHEN t.CustomProductCount > 0  THEN 'Custom'
					 ...
					 ELSE 'Ship' END
FROM [tblSwitch_BCD_TRON_RND_Duplex] s
...
FROM  [dbo].[tblSwitch_BCD_TRON_RND_Duplex] t
...
TRUNCATE TABLE tblSwitch_BCD_distinctIDCount_TRON_RND_Duplex
INSERT INTO tblSwitch_BCD_distinctIDCount_TRON_RND_Duplex (orderID, ordersProductsID)
SELECT DISTINCT orderID, ordersProductsID
FROM [dbo].[tblSwitch_BCD_TRON_RND_Duplex]

TRUNCATE TABLE tblSwitch_BCD_distinctIDCount2_TRON_RND_Duplex
INSERT INTO tblSwitch_BCD_distinctIDCount2_TRON_RND_Duplex (orderID, countOrderID)
SELECT orderID, COUNT(orderID) AS 'countOrderID'
FROM tblSwitch_BCD_distinctIDCount_TRON_RND_Duplex
GROUP BY orderID
ORDER BY OrderId
...
FROM [dbo].[tblSwitch_BCD_TRON_RND_Duplex] a 
INNER JOIN tblSwitch_BCD_distinctIDCount2_TRON_RND_Duplex b
...
IF OBJECT_ID(N'tblSwitch_BCD_displayCount_TRON_RND_Duplex', N'U') IS NOT NULL
DROP TABLE tblSwitch_BCD_displayCount_TRON_RND_Duplex

CREATE TABLE tblSwitch_BCD_displayCount_TRON_RND_Duplex
...
TRUNCATE TABLE tblSwitch_BCD_displayCount_TRON_RND_Duplex
INSERT INTO tblSwitch_BCD_displayCount_TRON_RND_Duplex (orderID, ordersProductsID, totalCount)
...
BEGIN
	...
	FROM tblSwitch_BCD_displayCount_TRON_RND_Duplex
...
--// update packetValue with sortable multi-digit numbers
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, '1 of', '01 of') WHERE displayCount LIKE '1 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, '2 of', '02 of') WHERE displayCount LIKE '2 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, '3 of', '03 of') WHERE displayCount LIKE '3 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, '4 of', '04 of') WHERE displayCount LIKE '4 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, '5 of', '05 of') WHERE displayCount LIKE '5 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, '6 of', '06 of') WHERE displayCount LIKE '6 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, '7 of', '07 of') WHERE displayCount LIKE '7 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, '8 of', '08 of') WHERE displayCount LIKE '8 of%'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, '9 of', '09 of') WHERE displayCount LIKE '9 of%'

UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, 'of 1', 'of 01') WHERE displayCount LIKE '%of 1'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, 'of 2', 'of 02') WHERE displayCount LIKE '%of 2'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, 'of 3', 'of 03') WHERE displayCount LIKE '%of 3'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, 'of 4', 'of 04') WHERE displayCount LIKE '%of 4'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, 'of 5', 'of 05') WHERE displayCount LIKE '%of 5'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, 'of 6', 'of 06') WHERE displayCount LIKE '%of 6'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, 'of 7', 'of 07') WHERE displayCount LIKE '%of 7'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, 'of 8', 'of 08') WHERE displayCount LIKE '%of 8'
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET displayCount = REPLACE(displayCount, 'of 9', 'of 09') WHERE displayCount LIKE '%of 9'

UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET switch_approve = 0
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET switch_print = 0
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET switch_approveDate = GETDATE()
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET switch_printDate = GETDATE()
UPDATE [dbo].[tblSwitch_BCD_TRON_RND_Duplex] SET switch_createDate = GETDATE()
...
INSERT INTO tblSwitch_pUnit_TRON_RND (pUnitID, OPID, duplex, orderID, orderNo, orderDate, customerID, shippingAddressID, shipCompany, shipFirstName, shipLastName, shipAddress1, shipAddress2, shipCity, shipState,
...
INNER JOIN [dbo].[tblSwitch_BCD_TRON_RND_Duplex] b ON a.OPID = b.ordersProductsID
WHERE b.front_UV = 1
AND b.back_UV = 1
AND a.duplex = 1
AND b.finishType <> 'ST'
...
TRUNCATE TABLE tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex
...
-- Now, any OPIDs that do not exist in the output data (tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex), but surpass the time threshold, must be inserted despite any havoc it creates on the six/group work.
...
SET @TOT = (SELECT COUNT(ID)
					...
					AND b.pUnitID NOT IN
						(SELECT pUnitID
						FROM tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex))
...
--Exception Threshold: Brute force any pUnit that has been resubmitted or has been marked for expressProduction and still has not made it into tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex
...
UPDATE a
SET simplex = 1
FROM tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex a
...
SET fPlex = 1
FROM tblSwitch_pUnit_TRON_RND a
INNER JOIN tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex b ON a.pUnitID = b.pUnitID
WHERE a.simplex = 1
AND a.fPlex = 0
...
--next, update tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex with the correctly flipped values from tblSwitch_pUnit_TRON_RND and then set isFlipped = 1
UPDATE tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex
SET isFlipped = 1,
...
UPDATE tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex SET backName = 'blank.pdf' WHERE backName = '' AND fPlex = 1
UPDATE tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex SET backName = 'blank.pdf' WHERE backName = '.pdf' AND fPlex = 1
UPDATE tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex SET variableWholeName = 'blank.pdf' WHERE variableWholeName = '.pdf' AND fPlex = 1
...
UPDATE tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex SET backName = '' WHERE backName = '.pdf' AND fPlex = 0
UPDATE tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex SET variableWholeName = '' WHERE variableWholeName = '.pdf' AND fPlex = 0
...
SET switch_create = 1,
	   ...
	   fastTrak_resubmit = 0
FROM tblOrders_Products op
INNER JOIN tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex t ON op.ID = t.ordersProductsID
...
INNER JOIN tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex t ON p.pUnitID = t.pUnitID
...
select 
flowName = 'BC_Duplex_TRON_RND'
,a.PKID
,a.ordersProductsID
,batchTimestamp = @CurrentDate
,jsonData = 
       (select *
       from tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex b
       where a.PKID = b.PKID
       for json path)
from tblSwitch_BCD_ThresholdDiff_TRON_RND_Duplex a
