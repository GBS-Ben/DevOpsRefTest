CREATE PROCEDURE [dbo].[ImposerBCCount]
AS
-------------------------------------------------------------------------------
-- Author      Jeremy Fifer
-- Created     09/10/18
...
--09/10/18		Created, jf.
--12/08/20		CKB, iFrame conversion changes
-------------------------------------------------------------------------------
...
op.ID NOT IN
	...
	AND (
				--Regular Duplex BCs
				optionCaption IN ('Product Back', 'Back Intranet PDF','CanvasHiresBack')	--added canvas iFrame conversion
			OR
				-- CYO Duplex BCs
