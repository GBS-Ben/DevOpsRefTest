CREATE PROCEDURE [dbo].[usp_Switch_PC] 
AS
/*
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
*/
DECLARE @flowName AS VARCHAR(20) = 'PC'

DECLARE @lastRunDate datetime = getdate();
EXEC ProcessStatus_Update 'PC Switch SP', @lastRunDate;
...
-- Flags
DECLARE @Flag BIT
SET @Flag = (SELECT FlagStatus FROM Flags WHERE FlagName = 'ImposerPC')
					   
--IF @Flag = 0
--BEGIN
UPDATE Flags
SET FlagStatus = 1
WHERE FlagName = 'ImposerPC'

--////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// FILE EXISTS

--First, validate image files
EXEC usp_OPPO_validateFile 'PC'

--////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// CREATE MAIN QUERY
IF OBJECT_ID('tempdb..#ImposerPC') IS NOT NULL 
DROP TABLE #ImposerPC
CREATE TABLE #ImposerPC (
	[orderID] [int] NULL,
...
INSERT INTO #ImposerPC (orderID, orderNo, orderDate, customerID, 
...
IF OBJECT_ID('tempdb..#tempPSUFileCheckImposerPC') IS NOT NULL 
DROP TABLE #tempPSUFileCheckImposerPC

CREATE TABLE #tempPSUFileCheckImposerPC (
...
INSERT INTO #tempPSUFileCheckImposerPC (FILE_EXISTS_ROWID, OPID)
SELECT x.rowID, q.ordersProductsID
FROM tblOPPO_fileExists x 
INNER JOIN #ImposerPC q ON x.OPID = q.ordersProductsID
...
BEGIN
	 SELECT @FILE_EXISTS_ROWID = FILE_EXISTS_ROWID,
				   @OPIDX = OPID
	 FROM #tempPSUFileCheckImposerPC
...
--////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// INSERT DATA
--insert data into #tblSwitch_PC based on file existence
DROP TABLE IF EXISTS #tblSwitch_PC
...
SET @json = (SELECT orderid,@flowName as switchflow from #tblSwitch_PC FOR JSON PATH);
...
IF OBJECT_ID('tempdb..#tempResubChoice_PC') IS NOT NULL 
DROP TABLE #tempResubChoice_PC

CREATE TABLE #tempResubChoice_PC (
RowID INT IDENTITY(1, 1), 
OPID INT)
...
INSERT INTO #tempResubChoice_PC (OPID)
...
DROP TABLE IF EXISTS #tblSwitch_PC_distinctIDCount
SELECT DISTINCT orderID, ordersProductsID
INTO #tblSwitch_PC_distinctIDCount
FROM #tblSwitch_PC

DROP TABLE IF EXISTS #tblSwitch_PC_distinctIDCount2
SELECT orderID, COUNT(orderID) AS 'countOrderID'
INTO #tblSwitch_PC_distinctIDCount2
FROM #tblSwitch_PC_distinctIDCount
GROUP BY orderID
ORDER BY orderID
...
FROM #tblSwitch_PC a 
INNER JOIN #tblSwitch_PC_distinctIDCount2 b ON a.orderID = b.orderID
...
DROP TABLE IF EXISTS #tblSwitch_PC_displayCount

CREATE TABLE #tblSwitch_PC_displayCount 
	(RowID INT IDENTITY(1, 1), 
	orderID INT, 
...
TRUNCATE TABLE #tblSwitch_PC_displayCount
INSERT INTO #tblSwitch_PC_displayCount (orderID, ordersProductsID, totalCount)
...
BEGIN
	...
	FROM #tblSwitch_PC_displayCount
...
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, '1 of', '01 of') WHERE displayCount LIKE '1 of%'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, '2 of', '02 of') WHERE displayCount LIKE '2 of%'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, '3 of', '03 of') WHERE displayCount LIKE '3 of%'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, '4 of', '04 of') WHERE displayCount LIKE '4 of%'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, '5 of', '05 of') WHERE displayCount LIKE '5 of%'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, '6 of', '06 of') WHERE displayCount LIKE '6 of%'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, '7 of', '07 of') WHERE displayCount LIKE '7 of%'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, '8 of', '08 of') WHERE displayCount LIKE '8 of%'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, '9 of', '09 of') WHERE displayCount LIKE '9 of%'

UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, 'of 1', 'of 01') WHERE displayCount LIKE '%of 1'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, 'of 2', 'of 02') WHERE displayCount LIKE '%of 2'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, 'of 3', 'of 03') WHERE displayCount LIKE '%of 3'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, 'of 4', 'of 04') WHERE displayCount LIKE '%of 4'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, 'of 5', 'of 05') WHERE displayCount LIKE '%of 5'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, 'of 6', 'of 06') WHERE displayCount LIKE '%of 6'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, 'of 7', 'of 07') WHERE displayCount LIKE '%of 7'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, 'of 8', 'of 08') WHERE displayCount LIKE '%of 8'
UPDATE #tblSwitch_PC SET displayCount = REPLACE(displayCount, 'of 9', 'of 09') WHERE displayCount LIKE '%of 9'
...
DROP TABLE IF EXISTS #tblSwitch_PC_ForOutput
...
,jsonData = 
       (select *
       from #tblSwitch_PC_ForOutput b
       where a.PKID = b.PKID
       for json path)
from #tblSwitch_PC_ForOutput a
...
SET switch_create = 1,
	...
	fastTrak_resubmit = 0
FROM tblOrders_Products op
INNER JOIN #tblSwitch_PC_ForOutput q ON op.ID = q.ordersProductsID
--////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// OUTPUT

SELECT *
FROM #tblSwitch_PC_ForOutput 
