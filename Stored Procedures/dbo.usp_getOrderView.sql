...
-- 01/24/22     Added gbscompany to add shop to orderview page, jsb.

--exec usp_getorderview 555776429
--exec usp_getorderview 555776454
-------------------------------------------------------------------------------

CREATE PROC [dbo].[usp_getOrderView]
@orderID INT

AS

SELECT DISTINCT
ov.company AS gbscompany
,a.calcOrderTotal
,a.calcTransTotal
,a.calcProducts
,a.calcOPPO
...
LEFT JOIN dbo.tblOrderView ov
	ON ov.orderID =a.orderID
