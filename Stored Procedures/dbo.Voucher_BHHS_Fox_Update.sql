CREATE PROCEDURE [dbo].[Voucher_BHHS_Fox_Update]
AS
--04/27/21		CKB, Markful
 ...
 --		SELECT 
	...
	--  FROM OPENROWSET('Microsoft.ACE.OLEDB.12.0', 'Excel 12.0;Database=c:\Excel\BHHS_Fox_Roach_Voucher_Bank.xlsx;HDR=YES', 'SELECT * FROM [BHHS Florida$]') o
