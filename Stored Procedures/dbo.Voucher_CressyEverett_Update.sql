CREATE PROCEDURE [dbo].[Voucher_CressyEverett_Update]
AS  
...
FROM OPENROWSET('Microsoft.ACE.OLEDB.12.0', 'Excel 12.0;Database=c:\Excel\CressyEverett_Voucher_Bank.xlsx;HDR=YES', 'SELECT * FROM [Vouchers$]') o
