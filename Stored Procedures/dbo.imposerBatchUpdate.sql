CREATE procEDURE [dbo].[imposerBatchUpdate] @ImpositionID INT
AS
/*
-------------------------------------------------------------------------------
Author		Jeremy Fifer
...
BEGIN
	...
	AND oppx.optionCaption NOT LIKE 'CanvasHiresInside%'		--iFrame conversion
	...
	AND oppx.optionCaption = 'CanvasHiresInside Print File'		--iFrame conversion
