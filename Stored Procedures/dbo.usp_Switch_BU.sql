CREATE proc [dbo].[usp_Switch_BU]
AS
/*
-------------------------------------------------------------------------------
Author      Jeremy Fifer
Created     10/20/16
Purpose     Pulls BU products into Switch for production.
-------------------------------------------------------------------------------
...
07/09/19		JF, variablewholename and calendars and canvas, update.
...
-------------------------------------------------------------------------------
*/
DECLARE @flowName AS VARCHAR(20) = 'BU'


DECLARE @lastRunDate datetime = getdate();
EXEC ProcessStatus_Update 'BU Switch SP', @lastRunDate;

DECLARE @UncBasePath VARCHAR(100); 
EXEC EnvironmentVariables_Get N'OPCDirectory',@VariableValue = @UncBasePath OUTPUT;

TRUNCATE TABLE tblSwitch_BU
INSERT INTO tblSwitch_BU (orderID, orderNo, orderDate, customerID, 
...
AND SUBSTRING(p.productCode, 3, 2) = 'BU'
...
AND op.ID NOT IN
		...
		WHERE deleteX <> 'yes'
		AND optionID = 518)				--- *** how to identify quickcard going forward? iframe***---
AND a.orderDate > CONVERT(DATETIME, '08/01/2019')
...
--// confirm that non-sport BUs have variableTopName that are blank.
UPDATE tblSwitch_BU
SET variableTopName = ''
...
--// update all Custom Inserted OPIDs to the hardcoded PDF path in the archive directory  10/12/2016. 
UPDATE x
SET 
...
INNER JOIN tblOrdersProducts_productOptions b ON a.ordersProductsID = b.ordersProductsID
WHERE b.deleteX <> 'yes'
AND b.optionCaption = 'Product Back'			-- doesn't apply to BU - iframe
...
SET @json = (SELECT orderid,@flowName as switchflow from tblSwitch_BU FOR JSON PATH);
...
IF OBJECT_ID('tempdb..#tempResubChoiceBU') IS NOT NULL 
DROP TABLE #tempResubChoiceBU

CREATE TABLE #tempResubChoiceBU (
...
INSERT INTO #tempResubChoiceBU (OPID)
...
TRUNCATE TABLE tblSwitch_BU_distinctIDCount
INSERT INTO tblSwitch_BU_distinctIDCount (orderID, ordersProductsID)
SELECT DISTINCT orderID, ordersProductsID
FROM tblSwitch_BU

TRUNCATE TABLE tblSwitch_BU_distinctIDCount2
INSERT INTO tblSwitch_BU_distinctIDCount2 (orderID, countOrderID)
SELECT orderID, COUNT(orderID) AS 'countOrderID'
FROM tblSwitch_BU_distinctIDCount
GROUP BY orderID
ORDER BY orderID

UPDATE tblSwitch_BU
SET totalCount = b.countOrderID
FROM tblSwitch_BU a INNER JOIN tblSwitch_BU_distinctIDCount2 b
...
IF OBJECT_ID(N'tblSwitch_BU_displayCount', N'U') IS NOT NULL
DROP TABLE tblSwitch_BU_displayCount

CREATE TABLE tblSwitch_BU_displayCount 
	(RowID INT IDENTITY(1, 1), 
	orderID INT, 
...
TRUNCATE TABLE tblSwitch_BU_displayCount
INSERT INTO tblSwitch_BU_displayCount (orderID, ordersProductsID, totalCount)
...
BEGIN
	...
	FROM tblSwitch_BU_displayCount
...
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, '1 of', '01 of') WHERE displayCount LIKE '1 of%'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, '2 of', '02 of') WHERE displayCount LIKE '2 of%'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, '3 of', '03 of') WHERE displayCount LIKE '3 of%'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, '4 of', '04 of') WHERE displayCount LIKE '4 of%'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, '5 of', '05 of') WHERE displayCount LIKE '5 of%'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, '6 of', '06 of') WHERE displayCount LIKE '6 of%'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, '7 of', '07 of') WHERE displayCount LIKE '7 of%'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, '8 of', '08 of') WHERE displayCount LIKE '8 of%'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, '9 of', '09 of') WHERE displayCount LIKE '9 of%'

UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, 'of 1', 'of 01') WHERE displayCount LIKE '%of 1'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, 'of 2', 'of 02') WHERE displayCount LIKE '%of 2'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, 'of 3', 'of 03') WHERE displayCount LIKE '%of 3'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, 'of 4', 'of 04') WHERE displayCount LIKE '%of 4'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, 'of 5', 'of 05') WHERE displayCount LIKE '%of 5'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, 'of 6', 'of 06') WHERE displayCount LIKE '%of 6'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, 'of 7', 'of 07') WHERE displayCount LIKE '%of 7'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, 'of 8', 'of 08') WHERE displayCount LIKE '%of 8'
UPDATE tblSwitch_BU SET displayCount = REPLACE(displayCount, 'of 9', 'of 09') WHERE displayCount LIKE '%of 9'
...
--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ end.
	...
	INNER JOIN tblOrdersProducts_ProductOptions b
		ON a.ordersProductsID = b.ordersProductsID
	WHERE  b.optionCaption = 'Background File Name'		-- doesn't apply to BU - iFrame
	AND b.deleteX <> 'yes'
	...
	INNER JOIN tblOrdersProducts_ProductOptions b
		ON a.ordersProductsID = b.ordersProductsID
	WHERE  b.optionCaption = 'Layout File Name'		-- doesn't apply to BU - iFrame
	AND b.deleteX <> 'yes'
	...
	INNER JOIN tblOrdersProducts_ProductOptions b
		ON a.ordersProductsID = b.ordersProductsID
	WHERE  b.optionCaption = 'Team 1 File Name'		-- doesn't apply to BU - iFrame
	AND b.deleteX <> 'yes'
	...
	INNER JOIN tblOrdersProducts_ProductOptions b
		ON a.ordersProductsID = b.ordersProductsID
	WHERE  b.optionCaption = 'Team 2 File Name'		-- doesn't apply to BU - iFrame
	AND b.deleteX <> 'yes'
	...
	INNER JOIN tblOrdersProducts_ProductOptions b
		ON a.ordersProductsID = b.ordersProductsID
	WHERE  b.optionCaption = 'Team 3 File Name'		-- doesn't apply to BU - iFrame
	AND b.deleteX <> 'yes'
	...
	INNER JOIN tblOrdersProducts_ProductOptions b
		ON a.ordersProductsID = b.ordersProductsID
	WHERE  b.optionCaption = 'Team 4 File Name'		-- doesn't apply to BU - iFrame
	AND b.deleteX <> 'yes'
	...
	INNER JOIN tblOrdersProducts_ProductOptions b
		ON a.ordersProductsID = b.ordersProductsID
	WHERE  b.optionCaption = 'Team 5 File Name'		-- doesn't apply to BU - iFrame
	AND b.deleteX <> 'yes'
	...
	INNER JOIN tblOrdersProducts_ProductOptions b
		ON a.ordersProductsID = b.ordersProductsID
	WHERE  b.optionCaption = 'Team 6 File Name'		-- doesn't apply to BU - iFrame
	AND b.deleteX <> 'yes'
...
--// Set flags
UPDATE tblSwitch_BU SET switch_approve = 0
UPDATE tblSwitch_BU SET switch_print = 0
UPDATE tblSwitch_BU SET switch_approveDate = GETDATE()
UPDATE tblSwitch_BU SET switch_printDate = GETDATE()
UPDATE tblSwitch_BU SET switch_createDate = GETDATE()
...
/* 
GNBU00-019	Babysitter Checklist
GNBU00-020	Emergency First Aid
GNBU00-021	Emergency Phone Numbers
GNBU00-022	Important Phone Numbers
GNBU00-023	Numeros de Emergencia
GNBU00-025	Primeros Auxilios
*/
UPDATE tblSwitch_BU
SET UV = 0
WHERE productCode = 'GNBU00-019'
OR productCode = 'GNBU00-020'
OR productCode = 'GNBU00-021'
OR productCode = 'GNBU00-022'
OR productCode = 'GNBU00-023'
OR productCode = 'GNBU00-025'
...
--INSERT INTO tblSwitch_BULog (PKID, ordersProductsID, insertedOn)
--SELECT DISTINCT PKID, ordersProductsID, GETDATE()
--FROM tblSwitch_BU_ForOutput
...
,jsonData = 
       (select *
       from tblSwitch_BU_ForOutput b
       where a.PKID = b.PKID
       for json path)
from tblSwitch_BU_ForOutput a
...
SET switch_create = 1,
	...
	fastTrak_resubmit = 0
FROM tblOrders_Products op
INNER JOIN tblSwitch_BU_ForOutput t ON op.ID = t.ordersProductsID
