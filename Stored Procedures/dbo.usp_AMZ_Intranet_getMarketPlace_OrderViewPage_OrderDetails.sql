CREATE PROCEDURE [dbo].[usp_AMZ_Intranet_getMarketPlace_OrderViewPage_OrderDetails]
@orderNo VARCHAR(255)
AS
-------------------------------------------------------------------------------
-- Author      Jeremy Fifer
...
-- Example:		EXEC usp_AMZ_Intranet_getMarketPlace_OrderViewPage_Basics 'WEB123456'
-------------------------------------------------------------------------------
