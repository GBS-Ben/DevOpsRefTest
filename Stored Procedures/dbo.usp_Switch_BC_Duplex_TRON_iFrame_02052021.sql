CREATE PROCEDURE [dbo].[usp_Switch_BC_Duplex_TRON_iFrame_02052021] 
AS
/*
-------------------------------------------------------------------------------
Author      Jeremy Fifer
...
INSERT INTO BC_LOG (lognote) SELECT '1'
...
-- Initialize data set
TRUNCATE TABLE tblSwitch_OPID_TRON
INSERT INTO tblSwitch_OPID_TRON (OPID, ReadyForSwitch)
...
TRUNCATE TABLE tblSwitch_BCD_TRON
INSERT INTO tblSwitch_BCD_TRON (orderID, orderNo, orderDate, customerID, 
...
INNER JOIN tblOrders_Products op ON a.orderID = op.orderID
INNER JOIN tblProducts p ON op.productID = p.productID
INNER JOIN tblSwitch_OPID_TRON q ON op.ID = q.OPID
WHERE op.[ID] NOT IN 
	(SELECT ordersProductsID 
	FROM tblSwitch_BCD_TRON
	WHERE ordersProductsID IS NOT NULL)

INSERT INTO BC_LOG (lognote) SELECT '2'
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
--////////////////////////////////////////////////// QUANTITY WORK /////////////////////////////////
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

--// First, fix productQuantity if fasTrak_newQTY value exists
UPDATE tblSwitch_BCD_TRON
SET productQuantity = b.fastTrak_newQTY
FROM tblSwitch_BCD_TRON a
...
TRUNCATE TABLE tblSwitch_BCD_TRON
INSERT INTO tblSwitch_BCD_TRON (orderID, orderNo, orderDate, customerID, shippingAddressID, shipCompany, shipFirstName, shipLastName, shipAddress1, shipAddress2, shipCity, shipState, shipZip, shipCountry, shipPhone, productCode, productName, shortName, productQuantity, packetValue, variableTopName, variableBottomName, variableWholeName, backName, numUnits, displayedQuantity, ordersProductsID, shipsWith, resubmit, shipType, samplerRequest, multiCount, totalCount, displayCount, background, templateFile, team1FileName, team2FileName, team3FileName, team4FileName, team5FileName, team6FileName, groupID, productID, parentProductID, switch_create, switch_createDate, switch_approve, switch_approveDate, switch_print, switch_printDate, switch_import, mo_orders_Products, mo_orders, mo_customers, mo_customers_ShippingAddress, mo_oppo, customProductCount, customProductCode1, customProductCode2, customProductCode3, customProductCode4, fasTrakProductCount, fasTrakProductCode1, fasTrakProductCode2, fasTrakProductCode3, fasTrakProductCode4, stockProductCount, stockProductQuantity1, stockProductCode1, stockProductDescription1, stockProductQuantity2, stockProductCode2, stockProductDescription2, stockProductQuantity3, stockProductCode3, stockProductDescription3, stockProductQuantity4, stockProductCode4, stockProductDescription4, stockProductQuantity5, stockProductCode5, stockProductDescription5, stockProductQuantity6, stockProductCode6, stockProductDescription6, front_UV, back_UV, customBackground, expressProduction)
SELECT orderID, orderNo, orderDate, customerID, shippingAddressID, shipCompany, shipFirstName, shipLastName, shipAddress1, shipAddress2, shipCity, shipState, shipZip, shipCountry, shipPhone, productCode, productName, shortName, productQuantity, packetValue, variableTopName, variableBottomName, variableWholeName, backName, numUnits, displayedQuantity, ordersProductsID, shipsWith, resubmit, shipType, samplerRequest, multiCount, totalCount, displayCount, background, templateFile, team1FileName, team2FileName, team3FileName, team4FileName, team5FileName, team6FileName, groupID, productID, parentProductID, switch_create, switch_createDate, switch_approve, switch_approveDate, switch_print, switch_printDate, switch_import, mo_orders_Products, mo_orders, mo_customers, mo_customers_ShippingAddress, mo_oppo, customProductCount, customProductCode1, customProductCode2, customProductCode3, customProductCode4, fasTrakProductCount, fasTrakProductCode1, fasTrakProductCode2, fasTrakProductCode3, fasTrakProductCode4, stockProductCount, stockProductQuantity1, stockProductCode1, stockProductDescription1, stockProductQuantity2, stockProductCode2, stockProductDescription2, stockProductQuantity3, stockProductCode3, stockProductDescription3, stockProductQuantity4, stockProductCode4, stockProductDescription4, stockProductQuantity5, stockProductCode5, stockProductDescription5, stockProductQuantity6, stockProductCode6, stockProductDescription6, front_UV, back_UV, customBackground, expressProduction
FROM tblSwitch_BCD_Bounce_TRON
ORDER BY ordersProductsID, packetValue

--// update packetValue with sortable multi-digit numbers
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, '1 of', '01 of') WHERE packetValue LIKE '1 of%'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, '2 of', '02 of') WHERE packetValue LIKE '2 of%'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, '3 of', '03 of') WHERE packetValue LIKE '3 of%'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, '4 of', '04 of') WHERE packetValue LIKE '4 of%'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, '5 of', '05 of') WHERE packetValue LIKE '5 of%'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, '6 of', '06 of') WHERE packetValue LIKE '6 of%'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, '7 of', '07 of') WHERE packetValue LIKE '7 of%'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, '8 of', '08 of') WHERE packetValue LIKE '8 of%'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, '9 of', '09 of') WHERE packetValue LIKE '9 of%'

UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, 'of 1', 'of 01') WHERE packetValue LIKE '%of 1'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, 'of 2', 'of 02') WHERE packetValue LIKE '%of 2'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, 'of 3', 'of 03') WHERE packetValue LIKE '%of 3'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, 'of 4', 'of 04') WHERE packetValue LIKE '%of 4'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, 'of 5', 'of 05') WHERE packetValue LIKE '%of 5'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, 'of 6', 'of 06') WHERE packetValue LIKE '%of 6'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, 'of 7', 'of 07') WHERE packetValue LIKE '%of 7'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, 'of 8', 'of 08') WHERE packetValue LIKE '%of 8'
UPDATE tblSwitch_BCD_TRON SET packetValue = REPLACE(packetValue, 'of 9', 'of 09') WHERE packetValue LIKE '%of 9'
...
INSERT INTO BC_LOG (lognote) SELECT '3'
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
--//////////////////////////////////////////////////// FINISH TYPE /////////////////////////////////////////////	
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
TRUNCATE TABLE tblSwitch_BCD_stockCount_TRON
INSERT INTO tblSwitch_BCD_stockCount_TRON (orderID, stockCount)
...
WHERE orderID IN
	(SELECT orderID 
	FROM tblSwitch_BCD_stockCount_TRON
	GROUP BY orderID
...
TRUNCATE TABLE tblSwitch_BCD_distinctIDCount_TRON
INSERT INTO tblSwitch_BCD_distinctIDCount_TRON (orderID, ordersProductsID)
SELECT DISTINCT orderID, ordersProductsID
FROM tblSwitch_BCD_TRON

TRUNCATE TABLE tblSwitch_BCD_distinctIDCount2_TRON
INSERT INTO tblSwitch_BCD_distinctIDCount2_TRON (orderID, countOrderID)
SELECT orderID, COUNT(orderID) AS 'countOrderID'
FROM tblSwitch_BCD_distinctIDCount_TRON
GROUP BY orderID
ORDER BY OrderId
...
FROM tblSwitch_BCD_TRON a 
INNER JOIN tblSwitch_BCD_distinctIDCount2_TRON b
ON a.orderID = b.orderID
...
DROP TABLE tblSwitch_BCD_displayCount_TRON

CREATE TABLE tblSwitch_BCD_displayCount_TRON
...
TRUNCATE TABLE tblSwitch_BCD_displayCount_TRON
INSERT INTO tblSwitch_BCD_displayCount_TRON (orderID, ordersProductsID, totalCount)
...
BEGIN
	...
	FROM tblSwitch_BCD_displayCount_TRON
...
--// update packetValue with sortable multi-digit numbers
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, '1 of', '01 of') WHERE displayCount LIKE '1 of%'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, '2 of', '02 of') WHERE displayCount LIKE '2 of%'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, '3 of', '03 of') WHERE displayCount LIKE '3 of%'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, '4 of', '04 of') WHERE displayCount LIKE '4 of%'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, '5 of', '05 of') WHERE displayCount LIKE '5 of%'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, '6 of', '06 of') WHERE displayCount LIKE '6 of%'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, '7 of', '07 of') WHERE displayCount LIKE '7 of%'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, '8 of', '08 of') WHERE displayCount LIKE '8 of%'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, '9 of', '09 of') WHERE displayCount LIKE '9 of%'

UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, 'of 1', 'of 01') WHERE displayCount LIKE '%of 1'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, 'of 2', 'of 02') WHERE displayCount LIKE '%of 2'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, 'of 3', 'of 03') WHERE displayCount LIKE '%of 3'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, 'of 4', 'of 04') WHERE displayCount LIKE '%of 4'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, 'of 5', 'of 05') WHERE displayCount LIKE '%of 5'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, 'of 6', 'of 06') WHERE displayCount LIKE '%of 6'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, 'of 7', 'of 07') WHERE displayCount LIKE '%of 7'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, 'of 8', 'of 08') WHERE displayCount LIKE '%of 8'
UPDATE tblSwitch_BCD_TRON SET displayCount = REPLACE(displayCount, 'of 9', 'of 09') WHERE displayCount LIKE '%of 9'

UPDATE tblSwitch_BCD_TRON SET switch_approve = 0
UPDATE tblSwitch_BCD_TRON SET switch_print = 0
UPDATE tblSwitch_BCD_TRON SET switch_approveDate = GETDATE()
UPDATE tblSwitch_BCD_TRON SET switch_printDate = GETDATE()
UPDATE tblSwitch_BCD_TRON SET switch_createDate = GETDATE()
...
--// customProductCount
TRUNCATE TABLE tblSwitch_BCD_countCustom_TRON
INSERT INTO tblSwitch_BCD_countCustom_TRON (orderID, countCustom)
...
FROM tblSwitch_BCD_TRON a
INNER JOIN tblSwitch_BCD_countCustom_TRON b
	ON a.orderID = b.orderID

--// Populate customProductCode fields
TRUNCATE TABLE tblSwitch_BCD_listCustom_TRON
INSERT INTO tblSwitch_BCD_listCustom_TRON (orderID, productCodePrefix)
...
FROM tblSwitch_BCD_TRON a
INNER JOIN tblSwitch_BCD_listCustom_TRON b
ON a.orderID = b.orderID
...
--// FTProductCount
TRUNCATE TABLE tblSwitch_BCD_countFT_TRON
INSERT INTO tblSwitch_BCD_countFT_TRON (orderID, countFT)
...
FROM tblSwitch_BCD_TRON a
INNER JOIN tblSwitch_BCD_countFT_TRON b
	ON a.orderID = b.orderID

--// Populate fasTrakProductCode fields
TRUNCATE TABLE tblSwitch_BCD_listFT_TRON
INSERT INTO tblSwitch_BCD_listFT_TRON (orderID, productCodePrefix)
SELECT DISTINCT a.orderID, SUBSTRING(b.productCode, 1 ,4) AS 'productCodePrefix'
FROM tblSwitch_BCD_TRON a
INNER JOIN tblOrders_Products b
ON a.orderID = b.orderID
...
FROM tblSwitch_BCD_TRON a
INNER JOIN tblSwitch_BCD_listFT_TRON b
ON a.orderID = b.orderID
...
--// stockProductCount
TRUNCATE TABLE tblSwitch_BCD_countStock_TRON
INSERT INTO tblSwitch_BCD_countStock_TRON (orderID, countStock)
...
FROM tblSwitch_BCD_TRON a
INNER JOIN tblSwitch_BCD_countStock_TRON b
	ON a.orderID = b.orderID

--// Populate stockProductCode fields (up to 3 slots because if >3, then we blank them all out anyways)
TRUNCATE TABLE tblSwitch_BCD_listStock_TRON
INSERT INTO tblSwitch_BCD_listStock_TRON (orderID, productCode)
...
FROM tblSwitch_BCD_TRON a
INNER JOIN tblSwitch_BCD_listStock_TRON b
ON a.orderID = b.orderID
...
DROP TABLE #tempResubChoice_BCD_TRON
...
IF OBJECT_ID(N'tblSwitch_TOT', N'U') IS NOT NULL
DROP TABLE tblSwitch_TOT
...
INSERT INTO tblSwitch_pUnit_TRON (pUnitID, OPID, duplex, orderID, orderNo, orderDate, customerID, shippingAddressID, shipCompany, shipFirstName, shipLastName, shipAddress1, shipAddress2, shipCity, shipState,
...
INNER JOIN tblSwitch_BCD_TRON b
...
INSERT INTO BC_LOG (lognote) SELECT '6'
-- UV ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
TRUNCATE TABLE tblSwitch_BCD_ThresholdDiff_TRON
...
SET @TOT = (SELECT COUNT(ID)
					FROM tblSwitch_OPID_TRON a
					INNER JOIN tblSwitch_pUnit_TRON b
						ON a.OPID = b.OPID
					WHERE b.uv_sort = 1
					...
					AND b.pUnitID NOT IN
						(SELECT pUnitID
						FROM tblSwitch_BCD_ThresholdDiff_TRON))
...
INSERT INTO BC_LOG (lognote) SELECT '7'
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
INNER JOIN tblSwitch_pUnit_TRON b ON a.pUnitID = b.pUnitID
WHERE b.simplex = 1
...
SET fPlex = 1
FROM tblSwitch_pUnit_TRON a
INNER JOIN tblSwitch_BCD_ThresholdDiff_TRON b ON a.pUnitID = b.pUnitID
WHERE a.simplex = 1
AND a.fPlex = 0
...
UPDATE tblSwitch_BCD_ThresholdDiff_TRON
SET isFlipped = 1,
...
UPDATE tblSwitch_BCD_ThresholdDiff_TRON SET backName = 'blank.pdf' WHERE backName = '' AND fPlex = 1
UPDATE tblSwitch_BCD_ThresholdDiff_TRON SET backName = 'blank.pdf' WHERE backName = '.pdf' AND fPlex = 1
UPDATE tblSwitch_BCD_ThresholdDiff_TRON SET variableWholeName = 'blank.pdf' WHERE variableWholeName = '.pdf' AND fPlex = 1
UPDATE tblSwitch_pUnit_TRON SET backName = 'blank.pdf' WHERE backName = '.pdf' AND fPlex = 1
UPDATE tblSwitch_pUnit_TRON SET variableWholeName = 'blank.pdf' WHERE variableWholeName = '.pdf' AND fPlex = 1

UPDATE tblSwitch_BCD_ThresholdDiff_TRON SET backName = '' WHERE backName = '.pdf' AND fPlex = 0
UPDATE tblSwitch_BCD_ThresholdDiff_TRON SET variableWholeName = '' WHERE variableWholeName = '.pdf' AND fPlex = 0
UPDATE tblSwitch_pUnit_TRON SET backName = '' WHERE backName = '.pdf' AND fPlex = 0
UPDATE tblSwitch_pUnit_TRON SET variableWholeName = '' WHERE variableWholeName = '.pdf' AND fPlex = 0
...
SET switch_create = 1,
	   ...
	   fastTrak_resubmit = 0
FROM tblOrders_Products op
INNER JOIN tblSwitch_BCD_ThresholdDiff_TRON t ON op.ID = t.ordersProductsID

INSERT INTO BC_LOG (lognote) SELECT '8'
...
INNER JOIN tblSwitch_BCD_ThresholdDiff_TRON t ON p.pUnitID = t.pUnitID
...
select 
flowName = 'BC_Duplex_TRON'
,a.PKID
,a.ordersProductsID
,batchTimestamp = @CurrentDate
,jsonData = 
       (select *
       from tblSwitch_BCD_ThresholdDiff_TRON b
       where a.PKID = b.PKID
       for json path)
from tblSwitch_BCD_ThresholdDiff_TRON a
...
INSERT INTO BC_LOG (lognote) SELECT '9'
