...
CREATE PROCEDURE [dbo].[usp_Switch_BC_Duplex_TRON_RND_iFrame_02052021] 
AS
/*
-------------------------------------------------------------------------------
Author      Jeremy Fifer
...
TRUNCATE TABLE tblSwitch_BCD_stockCount_TRON_RND_Duplex
INSERT INTO tblSwitch_BCD_stockCount_TRON_RND_Duplex (orderID, stockCount)
...
WHERE orderID IN
	(SELECT orderID 
	FROM tblSwitch_BCD_stockCount_TRON_RND_Duplex
	GROUP BY orderID
...
--// customProductCount
TRUNCATE TABLE tblSwitch_BCD_countCustom_TRON_RND_Duplex
INSERT INTO tblSwitch_BCD_countCustom_TRON_RND_Duplex (orderID, countCustom)
...
FROM tblSwitch_BCS_TRON a
INNER JOIN tblSwitch_BCD_countCustom_TRON_RND_Duplex b ON a.orderID = b.orderID

--// Populate customProductCode fields
TRUNCATE TABLE tblSwitch_BCD_listCustom_TRON_RND_Duplex
INSERT INTO tblSwitch_BCD_listCustom_TRON_RND_Duplex (orderID, productCodePrefix)
...
FROM tblSwitch_BCS_TRON a
INNER JOIN tblSwitch_BCD_listCustom_TRON_RND_Duplex b ON a.orderID = b.orderID
...
--// FTProductCount
TRUNCATE TABLE tblSwitch_BCD_countFT_TRON_RND_Duplex
INSERT INTO tblSwitch_BCD_countFT_TRON_RND_Duplex (orderID, countFT)
...
FROM tblSwitch_BCS_TRON a
INNER JOIN tblSwitch_BCD_countFT_TRON_RND_Duplex b ON a.orderID = b.orderID

--// Populate fasTrakProductCode fields
TRUNCATE TABLE tblSwitch_BCD_listFT_TRON_RND_Duplex
INSERT INTO tblSwitch_BCD_listFT_TRON_RND_Duplex (orderID, productCodePrefix)
SELECT DISTINCT a.orderID, SUBSTRING(b.productCode, 1 ,4) AS 'productCodePrefix'
FROM tblSwitch_BCS_TRON a
INNER JOIN tblOrders_Products b ON a.orderID = b.orderID
WHERE deleteX <> 'yes'
...
FROM tblSwitch_BCS_TRON a
INNER JOIN tblSwitch_BCD_listFT_TRON_RND_Duplex b ON a.orderID = b.orderID
...
--// stockProductCount
TRUNCATE TABLE tblSwitch_BCD_countStock_TRON_RND_Duplex
INSERT INTO tblSwitch_BCD_countStock_TRON_RND_Duplex (orderID, countStock)
...
FROM tblSwitch_BCS_TRON a
INNER JOIN tblSwitch_BCD_countStock_TRON_RND_Duplex b ON a.orderID = b.orderID

--// Populate stockProductCode fields (up to 3 slots because if >3, then we blank them all out anyways)
TRUNCATE TABLE tblSwitch_BCD_listStock_TRON_RND_Duplex
INSERT INTO tblSwitch_BCD_listStock_TRON_RND_Duplex (orderID, productCode)
...
FROM tblSwitch_BCS_TRON a
INNER JOIN tblSwitch_BCD_listStock_TRON_RND_Duplex b ON a.orderID = b.orderID
