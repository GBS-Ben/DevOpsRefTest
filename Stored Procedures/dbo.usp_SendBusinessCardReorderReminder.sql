...
CREATE PROCEDURE [dbo].[usp_SendBusinessCardReorderReminder] @NumberToSend int = 250
AS
SET NOCOUNT ON;
...
BEGIN TRY
	...
	--Remove previously sent emails that might exists....extra safe.
	DELETE tblBusinessCardReorderQueue
	WHERE opid in 
	(SELECT q.OPID
	FROM tblBusinessCardReorderqueue q
	INNER JOIN tblBusinessCardReorderEmailLog e on e.RecipientEmail = BusinessCardEmail
		and e.OPID = q.OPID
		and e.OrderNo = q.OrderNo
		)
	...
	SELECT TOP (@NumberToSend) OrderNo, --we limit records to send
			OrderId ,
			OPID,
			OrderEmail,
			BusinessCardEmail,
			...
			DaysSinceLastOrder,
			ImageUrl
	FROM tblBusinessCardReorderQueue
...
BEGIN
	...
	*.padbtm {
					  ...
					  <td align="center" style="text-align: center;" ><table width="540" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" align="center" class="width280 ">
						  <tr>
							<td class="herofont" align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; text-align:center; color:#003b78; font-size:20px; line-height:24px; padding-bottom:30px; " >It''s been a while since you ordered your business cards. <br>
							  If you are running low, <a href="http://www.markful.com/webservices/marketing.aspx?reorderlink=true&opid=' + CONVERT(varchar(20), @OPID) + '&utm_source=mrk&utm_medium=email&utm_content=bct&utm_campaign=reorderLnk" style="color:#ff6f06; text-decoration: none; ">reorder&nbsp;here.</a></td>
						  </tr>
						</table></td>
					</tr>
				  </table></td>
				...
				<td bgcolor="#e9e9ea" style="padding-top:25px; padding-bottom: 25px; background-color: #e9e9ea; "><table width="580" align="center" cellspacing="0" cellpadding="0" border="0" class="width320" style="margin: 0 auto;">
					<tr>
					  <td style="" align="center"><table width="540" align="center" cellspacing="0" cellpadding="0" border="0" class="width280">
						  <tr>
							<td class="width280" align="center"><a href="http://www.markful.com/webservices/marketing.aspx?reorderlink=true&opid=' + CONVERT(varchar(20), @OPID) + '&utm_source=mrk&utm_medium=email&utm_content=bct&utm_campaign=reorderLnk"><img width="540" border="0" alt="Football Schedule Sale Ends Thursday" style="display:block; border:none; outline:none; text-decoration:none;" src="' + @ImageUrl + '" class="fluid"></a></td>
						  </tr>
						</table></td>
					</tr>
				  </table></td>
					  ...
					  <tbody>
						<tr>
						  <td align="center" style="text-align: center" ><table width="450" cellpadding="0" cellspacing="0" border="0" align="center" class="width280" style="margin: 0 auto;">
							  <tbody>
								<tr>
								  <td style="font-family: Helvetica, arial, sans-serif; text-align:center; color:#003b78; font-size:16px; line-height:20px; padding-top:30px; padding-bottom:5px; letter-spacing:.1em "><a href="https://www.markful.com/default.asp?utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=mrk" style="color:#333333; text-decoration:none; font-weight:normal; font-size:14px;">MAGNETIC MARKETING</a></td>
								</tr>
								<tr>
								  <td class="block" style="font-family: Helvetica, arial, sans-serif; text-align:center; color:#003b78; font-size:16px; line-height:20px; padding-top:0px; padding-bottom:30px; "><a href="https://www.markful.com/calendars/default.aspx?utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=cals" style="color:#003b78; text-decoration: none;">Calendars</a>&nbsp;<span style="color:#afafaf;">&bull;</span> <a href="https://www.markful.com/sports/default.aspx?utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=sports" style="color:#003b78; text-decoration: none;">Sports Magnets</a>&nbsp;<span style="color:#afafaf;">&bull;</span> <a href="https://www.markful.com/notepads/default.aspx?utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=notepads" style="color:#003b78; text-decoration: none;">Notepads</a><br>
									<a href="https://www.markful.com/gateway/gateway.aspx?code=specialty-magnets&utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=specialty" style="color:#003b78; text-decoration: none; ">Specialty</a>&nbsp;<span style="color:#afafaf;">&bull;</span> <a href="http://www.markful.com/gallery/gallery.aspx?code=whiteboards&utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=whiteboards" style="color:#003b78; text-decoration: none;">Whiteboards</a></td>
								</tr>
							  </tbody>
							</table></td>
						</tr>
					  ...
					  <tbody>
						<tr>
						  <td align="center" style="text-align: center;" ><table width="450" cellpadding="0" cellspacing="0" border="0" align="center" class="width280" style="margin: 0 auto;">
							  <tbody>
								<tr>
								  <td style="font-family: Helvetica, arial, sans-serif; text-align:center; color:#003b78; font-size:16px; line-height:20px; padding-top:0px; padding-bottom:5px; letter-spacing:.1em "><a href="http://www.markful.com/market-centers/default.aspx?utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=marketcenters" style="color:#333333; text-decoration:none; font-weight:normal; font-size:14px;">BUSINESS PRODUCTS</a></td>
								</tr>
								<tr>
								  <td class="block" style="font-family: Helvetica, arial, sans-serif; text-align:center; color:#003b78; font-size:16px; line-height:20px; padding-top:0px; padding-bottom:30px; "><a href="https://www.markful.com/main_badge.asp?utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=namebadge" style="color:#003b78; text-decoration: none;">Name&nbsp;Badges</a>&nbsp;<span style="color:#afafaf;">&bull; </span><a href="https://www.markful.com/business-cards/default.aspx?utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=bizcards " style="color:#003b78; text-decoration: none;">Business&nbsp;Cards</a>&nbsp;<span style="color:#afafaf;">&bull;</span> <a href="https://www.markful.com/pens/pens-gallery.aspx?utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=pens" style="color:#003b78; text-decoration: none;">Logo&nbsp;Pens</a><br>
									<a href="https://www.markful.com/car-magnets/default.aspx?utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=carmagnets" style="color:#003b78; text-decoration: none;">Car&nbsp;Magnets</a>&nbsp;<span style="color:#afafaf;">&bull;</span> <a href="http://www.markful.com/gallery/gallery.aspx?code=awards&utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=awards" style="color:#003b78; text-decoration: none;">Awards</a>&nbsp;<span style="color:#afafaf;">&bull;</span> <a href="https://www.markful.com/notecardcafe/default.aspx?utm_source=cordial&utm_medium=email&utm_content=recNav&utm_campaign=ncc" style="color:#003b78; text-decoration: none;">Note&nbsp;Cards</a></td>
								</tr>
							  </tbody>
							</table></td>
						</tr>
				...
				<td><table bgcolor="#01265b" width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="width320" style="margin: 0 auto;">
					<tr>
					  <td><table width="540" align="center" cellpadding="0" cellspacing="0" border="0" class="width280">
						  ...
						  <tr>
							<td style="padding-top:5px; padding-bottom:5px; font: normal 11px/25px Arial, Helvetica, sans-serif; color:#FFFFFF !important;" align="center" bgcolor="#01265b">800.789.6247 &nbsp; |&nbsp;<a style="color:#ffffff;" href="mailto:info@markful.com">INFO@markful.COM</a></td>
						  </tr>
				...
				<td><table bgcolor="#023f7e" width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="width320" style="margin: 0 auto;">
					<tr>
					  <td align="center"><table width="60" align="center" vaalign="middle"  border="0" cellpadding="10" cellspacing="0">
						  <tr>
							<td width="25"  align="center"><div class="imgpop"> <a href="https://www.facebook.com/markful"> <img src="https://d1ok0qgebci2d3.cloudfront.net/130/40x40/facebook_circle.png" alt="Facebook" border="0" width="40" height="40" style="display:block; border:none; outline:none; text-decoration:none;"> </a> </div></td>
							<td width="25" align="center"><div class="imgpop"> <a href="https://twitter.com/markful"> <img src="https://d1ok0qgebci2d3.cloudfront.net/130/40x40/twitter_circle.png" alt="Twitter" border="0" width="40" height="40" style="display:block; border:none; outline:none; text-decoration:none;"> </a> </div></td>
						  </tr>
						</table></td>
					</tr>
				  </table></td>
						  ...
						  <tr>
							<td style="text-align:left; font-family: Arial,Verdana,sans-serif;font-size: 10px; color: #9a9a9a; line-height: 12px; font-weight:normal;"> This publication is intended for industry professionals only and complies with Federal law. If, for some reason, this was sent in error or you would not like to have any more contact from Markful, simply click the remove me link below. <br>
							  ...
							  * * *<br>
							  ...
							  <br>
							  * * *<br>
							  This email comes to you from Markful, which is affiliated with Note Card Cafe, Giving Cards, Atomic Envelopes, Bella Gift Wrap, Team Magnet Promotions, and Magnetic Attractions. Parent company is Graphic Business Solutions: www.gogbs.com <br>
							  <br>
							  To read our privacy policy, please <a href="http://www.markful.com/privacypolicy.asp" style="color:#9a9a9a; text-decoration: underline;" >click here</a>. <br>
							  <br>
							  This is a product offering from Markful, 1912 John Towers Ave, El Cajon, CA 92020. <br>
							  <br>
							  If you have any questions, reply to this email, or email <a href="mailto:info@markful.com" style="color:#9a9a9a; text-decoration: underline;" >info@markful.com</a> or call (800) 789-6247 (outside the U.S./Canada, dial (619) 258-4087). © 2017 Markful. All rights reserved.<br>
							  <br>
							  <a href="http://www.markful.com/email-remove/email-remove.asp?e='+ @Recipient +'" style="color:#9a9a9a; text-decoration: underline;" >Remove me from reminder emails</a></td>
						  </tr>
						</table></td>
					</tr>
				  </table></td>
	...
	BEGIN
					...
					SELECT GETDATE(), 
						@ImageUrl, 
						'http://www.markful.com/webservices/marketing.aspx?reorderlink=true&opid=' + convert(varchar(100),@OPID) ,
						 @tableHTML, 
						 @Recipient,
						 @OPID,
						 @OrderNo
			...
			DELETE tblBusinessCardReorderQueue WHERE businessCardEmail = @Recipient AND OrderNo = @OrderNo AND opid = @Opid
			 ...
			 DELETE @Orders WHERE businessCardEmail = @Recipient AND OrderNo = @OrderNo AND opid = @Opid
