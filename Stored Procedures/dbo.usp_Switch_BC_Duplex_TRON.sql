CREATE PROCEDURE [dbo].[usp_Switch_BC_Duplex_TRON] 
AS
/*
-------------------------------------------------------------------------------
Author      Jeremy Fifer
...
BEGIN TRY
DECLARE @flowName AS VARCHAR(20) = 'BC'
----Flags
--DECLARE @Flag BIT
...
EXEC ProcessStatus_Update 'BC_Duplex_TRON Switch SP', @lastRunDate;
--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
--////////////////////////////////////// INITIALIZE OPID //////////////////////////////////////
--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
SET @json = (SELECT orderid,@flowName as switchflow from tblSwitch_BCD_TRON FOR JSON PATH);
