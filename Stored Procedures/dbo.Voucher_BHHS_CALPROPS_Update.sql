CREATE PROCEDURE [dbo].[Voucher_BHHS_CALPROPS_Update]
AS
--04/27/21		CKB, Markful
 ...
 --		SELECT 
	...
	--  FROM OPENROWSET('Microsoft.ACE.OLEDB.12.0', 'Excel 12.0;Database=c:\Excel\BHHS_CalProps_Voucher_Bank.xlsx;HDR=YES', 'SELECT * FROM [BHHS CA NV AZ$]') o
